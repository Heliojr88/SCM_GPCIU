...
<html lang="en">
  <head>
    ...
    <title>Lista de Alterações de Materiais</title>
          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>LISTA DE ALTERAÇÕES <small> </small></h3>
              </div>
			  <form>
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered bulk_action">
					  ...
					  <?php
					   ...
					   if(!empty($datainicial) and !empty($datainicial))
					   {
						 ...
						 $consulta = $_pdo->getAlteracaoData($datainicial,$datafinal);
					   }
					   else
					   {
							$consulta = $_pdo->getAlteracao();   
					   }
