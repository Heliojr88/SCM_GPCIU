...
<html lang="en">
  <head>
    ...
    <title>Lista de Tramitações de Materiais</title>
          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Lista de Tramitações <small> </small></h3>
              </div>
                <form>
		    <div class="form-group">
                        <label for="patrimonio">Data Inicial </label>
                        
                          <input id="datainicial" type="Date" name="datainicial">
						  
			    <label for="patrimonio">Data Final </label>
                  ...
                  <div class="x_content">
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered bulk_action">
					  ...
					  <?php
					   ...
					   if(!empty($datainicial) and !empty($datainicial))
					   {
						 $datainicial = $_GET['datainicial'];
						 $datafinal   = $_GET['datafinal'];
						 
						 $consulta = $_pdo->getTramitacaoData($datainicial,$datafinal);
					   }
					   else
					   {
							$consulta = $_pdo->getTramitacao();   
					   }
					  ...
					  ?>
                        ...
                        <tr>
                          <td data-order="<?= strtotime($material['DataHora']) ?>"><?= e($material['dataTramitacao']) ?></td>
                          <td><?= e($material['DescricaoMat']) ?></td>
                          <td><?= e($material['Quantidade']) ?></td>
                          <td><?= e($material['NumPatrimonio']) ?></td>
                          <td><?= e($material['Origem']) ?></td>
                          <td><?= e($material['Destino']) ?></td>
