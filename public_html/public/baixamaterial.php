...
// ALTERADO: Proteção CSRF na baixa de material.
if (!scmValidateCsrfToken()) {
    echo"<script language='javascript' type='text/javascript'>alert('Sessão inválida. Atualize a página e tente novamente.');window.location.href='baixamaterial.php';</script>";
    die();
}
...
if($ativar){
    ...
    echo"<script language='javascript' type='text/javascript'>alert('Falha na baixa do material, verifique os dados digitados!');</script>";
}
          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Baixa de Material <small></small></h2>
                  ...
                  <div class="x_content">
				   ...
				   <form action="baixamaterial.php" id="materiais" name="materiais" method="POST" class="form-horizontal form-label-left">
					  ...
					  <div class="form-group">
                        <label for="alteracao" class="control-label col-md-3 col-sm-3 col-xs-12" for="alteracao">Motivo Baixa</label><span class="required">*</span>
