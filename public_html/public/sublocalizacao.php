...
//função PDO para cadastrar sub localização
          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Sub Localização<small></small></h2>
                    ...
                    <form action="sublocalizacao.php" id="ManterLocalizacao" name="ManterLocalizacao" method="POST" class="form-horizontal form-label-left">
					   ...
					   <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <select class="meuselect" name="localizacao" style="min-width:325px">
                            <?php
			 ...
			 <div class="form-group">
                        <label for="localizacao" class="control-label col-md-3 col-sm-3 col-xs-12" for="sublocalizacao">Sub Localização</label><span class="required">*</span>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            
                          <input id="sublocalizacao" type="text" required="required" class="form-control col-md-7 col-xs-12" type="text" name="sublocalizacao">
                        </div>
                      </div>
                    <!-- checbox inserido pra saber se é tramitável -->    
                    <div class="form-check">
                        <label  class="control-label col-md-3 col-sm-3 col-xs-12" for="tramitável">É portátil (bolsa, caixa, etc.)?</label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input id="tramitavel" type="checkbox"  class="form-check-input" value="1" name="tramitavel">
                        </div>
                        </label>
                      </div>
