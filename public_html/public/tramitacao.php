...
// ALTERADO: Proteção CSRF na tramitação individual.
if (!scmValidateCsrfToken()) {
    echo"<script language='javascript' type='text/javascript'>alert('Sessão inválida. Atualize a página e tente novamente.');window.location.href='tramitacao.php';</script>";
    die();
}
			...
			<div class="form-group">
		      ...
		      <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="sublocalizacao">Sub Localização</label>
                        <div class="col-md-9 col-sm-9 col-xs-12">
                            <select class="meuselect" name="sublocalizacao" id="sublocalizacao" style="min-width:325px">
                      ...
                      <div class="form-group">
                        <label for="quantidade" class="control-label col-md-3 col-sm-3 col-xs-12" for="quantidade">Quantidade</label><span class="required">*</span>
...
<script>
	...
	$(document).ready(function(){
		...
		selDestino.change(function(){
			...
			function(data){
				$("#sublocalizacao").empty();
				$("#sublocalizacao").append(data);
				$(".meuselect").select2();
			});
