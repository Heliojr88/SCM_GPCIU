                  ...
                  <div class="x_content">
				   ...
				   <form action="recuperaSenha.php" id="recuperaSenha" name="recuperaSenha" method="POST" class="form-horizontal form-label-left">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="siape" name="siape" class="form-control col-md-7 col-xs-12" type="number" maxlength="7" name="siape">
                        </div>
                      </div>
					  ...
					  <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="senha" type="password" class="form-control col-md-7 col-xs-12" required="required" type="text" name="senha">
                        </div>
                      </div>
					  ...
					  <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="senha2" type="password" class="form-control col-md-7 col-xs-12" required="required" type="text" name="senha2">
                        </div>
                      </div>
