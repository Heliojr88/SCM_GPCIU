...
if($master['master'] != 1){
 ...
 if ($ativa==0){
	  ...
	  $email_assunto = "Ativação de usuário no SCM - 17° GBM";
          $mensagem =  "Caro Usuário, o seu login foi ativado com sucesso! Bem vindo ao Sistema de Controle de Materiais - SCM - 17º GBM. \n\n";
          $mensagem .= "Acesse o Sistema no link: www.agenciageeks.com.br/deposito \n\n";
          $mensagem .= "Att, SCM - 17º GBM.";
          ...
          <div class="">
			...
			<div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <select class="meuselect" name="usuario" style="min-width:325px">
                            <?php
					  
                            $consulta = $_pdo->getUsuarios();
                        ...
                        <div class="form-group">
                            <input type="radio" name="ativar" value="1" checked>Ativar<br> 
                            <input type="radio" name="ativar" value="0"> Desativar<br>
                        </div>
