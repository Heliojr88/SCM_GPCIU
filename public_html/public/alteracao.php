          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Alteração de Material <small></small></h2>
				   ...
				   <form action="alteracao.php" id="materiais" name="materiais" method="POST" class="form-horizontal form-label-left">
                      ...
                      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="material">Materiais</label>
                        <div class="col-md-9 col-sm-9 col-xs-12">
					      <select class="meuselect" name="material" id="material">
						  <?php
						 ...
						 <input type="hidden" name="Localizacao" id="Localizacao" value="<?php echo $material['Localizacao_idLocalizacao'] ?>" />
					     </select>
						</div>
                      </div>
					  ...
					  <div class="form-group">
                        <label for="alteracao" class="control-label col-md-3 col-sm-3 col-xs-12" for="alteracao">Alterações</label><span class="required">*</span>
                     ...
                     <!--DELVAN: campo para receber já no cadastro da alteração o número do memorando no SEI-->                      
                     <div class="form-group">
                        <label for="memorandoSei" class="control-label col-md-3 col-sm-3 col-xs-12" for="memorandoSei">N. memorando SEI</label><span class="required">*</span>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="memorandoSei" type="text" required="required" class="form-control col-md-7 col-xs-12" type="text" name="memorandoSei">
                        </div>
                      </div>
                     <!--Fim do código referente ao campo que inseri-->
