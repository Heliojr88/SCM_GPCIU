                  ...
                  <div class="x_content">
				   ...
				   <form action="localizacao.php" id="localizacao" name="localizacao" method="POST" class="form-horizontal form-label-left">
					  ...
					  <div class="form-group">
                        <label for="localizacao" class="control-label col-md-3 col-sm-3 col-xs-12" for="localizacao">Localização</label><span class="required">*</span>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="localizacao" type="text" required="required" class="form-control col-md-7 col-xs-12" type="text" name="localizacao">
                        </div>
                      </div>
