...
if ($posicao === false) {
    echo "<script>alert('Material inválido.');window.location.href='ativamaterial.php';</script>";
    exit;
}
...
$ativar = $_pdo->ativaMaterial($idGrupoMat,$idLocal,$alteracao,$quantidade,$memorando,$idUsuario,$siape);

if($ativar){
    audit_log('material.ativa', "$idGrupoMat/$idLocal", [
        'quantidade' => $quantidade,
        'memorando'  => $memorando,
    ]);
    echo"<script language='javascript' type='text/javascript'>alert('Material ativado com sucesso!');</script>";
}
else{
    echo"<script language='javascript' type='text/javascript'>alert('Falha na ativação do material, verifique os dados digitados!');</script>";
}
                  ...
                  <div class="x_content">
				   ...
				   <form action="ativamaterial.php" id="materiais" name="materiais" method="POST" class="form-horizontal form-label-left">
					<?php csrf_field(); ?>
                      ...
                      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="material" >Materiais</label>
                        <div class="col-md-9 col-sm-9 col-xs-12">
						  ...
						  <?php
						    ...
						    $consulta = $_pdo->getMaterialBaixados();
					  ...
					  <div class="form-group">
                        <label for="alteracao" class="control-label col-md-3 col-sm-3 col-xs-12" for="alteracao">Motivo Ativação</label><span class="required">*</span>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="alteracao" type="text" required="required" class="form-control col-md-7 col-xs-12" type="text" name="alteracao">
                        </div>
                      </div>
					  ...
					  <div class="form-group">
                        <label for="quantidade" class="control-label col-md-3 col-sm-3 col-xs-12" for="memorando">Memorando</label><span class="required">*</span>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="memorando" type="text" required="required" class="form-control col-md-7 col-xs-12" type="text" name="memorando">
                        </div>
                      </div>					  
                      </div>
