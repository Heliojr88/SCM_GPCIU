...
<html lang="en">
  <head>
    ...
    <title>Manutenção de Localizações</title>
      ...
      <div class="main_container">
          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Manutenção de Localizações</h3>
              </div>
		...
		<form action="ManterLocalizacao.php" id="ManterLocalizacao" name="ManterLocalizacao" method="POST" class="form-horizontal form-label-left">
                    ...
                    <div class="form-group">
                       ...
                       <div class="form-group">
                        <label for="localizacao" class="control-label col-md-3 col-sm-3 col-xs-12" for="novalocalizacao"></label><span class="required">*</span>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="novalocalizacao" type="text" required="required" class="form-control col-md-7 col-xs-12" type="text" name="novalocalizacao">
                        </div>
                      </div>
                    
                    <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="radio" name="ativa" value="1" checked>Ativar<br> 
                            <input type="radio" name="ativa" value="0"> Desativar<br>
                        </div>
